...
class BaiDang(models.Model):
    Id_NguoiDang = models.ForeignKey(User, on_delete=models.PROTECT)
...
class TuongTac(models.Model):
    Id_BaiDang = models.ForeignKey(BaiDang, on_delete=models.PROTECT)
    Id_NguoiDung = models.ForeignKey(User, on_delete=models.PROTECT)
...
class TinNhan(models.Model):
    Id_NguoiGui = models.ForeignKey(User, on_delete=models.PROTECT, related_name='tin_nhan_gui')
    Id_NguoiNhan = models.ForeignKey(User, on_delete=models.PROTECT, related_name='tin_nhan_nhan')
...
class ChiTietThongBao(models.Model):
    Id_NguoiNhan = models.ForeignKey(User, on_delete=models.PROTECT)
    Id_ThongBao = models.ForeignKey(ThongBao, on_delete=models.PROTECT)
    DaXem = models.BooleanField(default=False)